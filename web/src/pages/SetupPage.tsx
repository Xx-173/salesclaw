        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 rounded-2xl overflow-hidden">
              <img src={`${import.meta.env.BASE_URL}icons/icon-192.png`} alt="SalesClaw" className="w-full h-full object-cover" />
            </div>
          </div>
          <h1 className="text-2xl font-bold text-foreground mb-1">SalesClaw 初始设置</h1>
