              ...
              <div className="grid gap-3 sm:grid-cols-3">
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-1 text-sm font-medium text-foreground">
                    {inheritsHostClaude ? '继承 ~/.claude' : 'SalesClaw 管理'}
                  </div>
                </div>
                <div className="min-w-0">
                  <div className="text-[11px] font-medium text-muted-foreground">
              ...
              <p className="mt-2 border-t pt-2 text-[11px] leading-5 text-muted-foreground">
                {canHostExec
                  ? inheritsHostClaude
                    ...
                    : '运行位置只决定命令在哪里执行。该智能体使用 SalesClaw 管理的上下文与附加能力。'
                  : '工作区固定在 Docker 容器中运行，并使用 SalesClaw 管理的智能体上下文与附加能力。'}
              </p>
            </div>
          )}
                ...
                {executionMode === 'host' && (
                  <>
                    <DirectoryBrowser
                      ...
                      label="宿主机工作目录（可选）"
                      description="智能体将直接在 SalesClaw 服务器上的这个目录中运行。"
